							...
							<div className="col-md-6">
								<div className='card'>
									<div className='card-body'  style={{ height: '90vh' }}>
										<div className='content-body'  id="banner" style={{ display: 'block' }} >
											<h1 id="headingtitle" className='h1 mb-3 text-center' ><i className="fas fa-home"></i> HOME</h1>
											<hr/>
											<h4 id="hediang4" className='h4 text-center mb-3'>WELCOME TO</h4>
											<p id="heading42" className='text-center'><i  className="fas fa-coins"></i> <i className="fas fa-coins"></i>MINA PROTOCOL TESTING <i className="fas fa-coins"></i> <i className="fas fa-coins"></i></p>
											<img className="img mb-2 mx-auto" style={{ display: 'block' }} src="bg.png" alt="mina"/>
											<div className='pt-4 mb-5'>
												<div className='coleb text-center'>
													{/* <span className='mina'>Mina</span> <span className='cx'>X</span> <span className='aurowallet' >aurowallet</span> */}

													<div className='d-flex justify-content-center w-100 mt-3 mb-3'>
														<img className={styles.imglogo} style={{ marginRight: '15px' }} src="MINA.png" alt="mina"/>
														<img className={styles.imglogo} src="aurowallet.png" alt="aurowallet"/>
													</div>
											...
											<hr/>
											<a id="connectBtn" className="btn btn-outline-info btn-style-four " style={{ display: 'block' }} onClick={() => { connectBtnclick(); connectWallet(); }}>
												 Connect
											</a>
											
										</div>
										<span id="loadingBtn" style={{ display: 'none' }}> 
										...
										<a id="backNoAccount" className='btn btn-outline-danger' style={{ display: 'none' }} onClick={() => { backNoAccountClick(); }}>
										...
										<div id="footer" style={{ display: 'block' }} >
											<ul className='sociallink list-inline text-center mt-3'>
